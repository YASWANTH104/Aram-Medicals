    ...
    <>
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10 mb-16">
        ...
        <div className="flex-1">
          <h1 className="text-4xl md:text-5xl font-bold mb-3" style={{ color: '#0833a8' }}>Dr. Ranganathan R RM</h1>
          ...
          <div className="flex flex-col gap-3 text-lg text-gray-700">
            ...
            <div>
              <span className="font-semibold" style={{ color: '#0833a8' }}>Phone:</span> <a href="tel:966741147" style={{ color: '#98C341' }} className="hover:underline">96674 1147</a>
            </div>
            <div>
              <span className="font-semibold" style={{ color: '#0833a8' }}>Email:</span> <a href="mailto:info@arammedicalfoundation.com" style={{ color: '#98C341' }} className="hover:underline">info@arammedicalfoundation.com</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full mb-16 text-center px-4 md:px-8">
        <div className="rounded-2xl shadow-lg p-8 md:p-12 bg-gradient-to-r from-[#f8fafc] to-[#f3f4f6]">
          <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: '#0833a8' }}>Our Story & Mission</h2>
          <p className="text-xl text-gray-700 mb-6 leading-relaxed">
            <span style={{ color: '#98C341', fontWeight: 600 }}>Aram Medical Foundation</span> is dedicated to providing state-of-the-art cardiac care with a focus on prevention, diagnosis, and treatment. We believe in compassionate service, continuous improvement, and making a positive impact on every patient's life.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6 mt-8">
            <Link to="/contact" className="rounded-lg p-8 flex-1 min-w-[220px] bg-gradient-to-br from-[#e0ffe7] to-[#b2f5ea] hover:shadow-lg transition-shadow duration-200">
              <div className="font-semibold mb-3 text-lg" style={{ color: '#0833a8' }}>Book an Appointment</div>
              <div className="block font-bold text-2xl mb-2" style={{ color: '#98C341' }}>86674 11477</div>
              <div className="block text-lg" style={{ color: '#98C341' }}>info@arammedicalfoundation.com</div>
            </Link>
            <div className="rounded-lg p-8 flex-1 min-w-[220px] bg-gradient-to-br from-[#e3f0ff] to-[#c9e4ff]">
              <div className="font-semibold mb-3 text-lg" style={{ color: '#0833a8' }}>Location</div>
              <div className="text-gray-700 text-lg">91,91/1-91/4, New Scheme Road, Pollachi - 642 001</div>
              <a href="https://goo.gl/maps/8Qw8Qw8Qw8Qw8Qw8Q" target="_blank" rel="noopener noreferrer" className="block mt-2 hover:underline text-lg" style={{ color: '#98C341' }}>Get Directions</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="relative flex flex-col items-center">
          ...
          >
            <div className="bg-gradient-to-r from-[#e0f7fa] to-[#f3e5f5] rounded-2xl shadow-lg p-12 flex flex-col items-center min-h-[340px] transition-all duration-300">
              ...
              <div className="font-bold text-xl md:text-2xl mt-2" style={{ color: '#98C341' }}>{testimonials[testimonialIdx].name}</div>
              {testimonials[testimonialIdx].role && <div className="text-lg text-gray-500 mt-1">{testimonials[testimonialIdx].role}</div>}
            </div>
          </div>
          {/* Carousel Controls */}
          <div className="flex items-center gap-4 mt-8">
            <button onClick={prevTestimonial} className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-[#98C341] hover:text-white text-[#0833a8] transition-colors text-xl">
            ...
            <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className={`w-4 h-4 rounded-full ${testimonialIdx === idx ? 'bg-[#98C341]' : 'bg-gray-300'} transition-colors`}
                      aria-label={`Go to testimonial ${idx + 1}`}
                    />
                  ))}
            </div>
            <button onClick={nextTestimonial} className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-[#98C341] hover:text-white text-[#0833a8] transition-colors text-xl">
