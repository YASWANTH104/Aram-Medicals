...
import { FaMapMarkerAlt, FaEnvelope, FaCheck, FaExclamationTriangle, FaSpinner } from 'react-icons/fa';
...
const ContactUs = () => {
  ...
  const medicalDepartments = [
    ...
    { value: 'general-surgery', label: 'General Surgery', icon: '⚕️' },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Error: ${error.message || 'There was an error submitting your message. Please try again.'}`);
    } finally {
  ...
  const getFieldIcon = (fieldName) => {
    ...
    if (status === 'success') return <FaCheck className="text-green-500" />;
    return null;
  };

  const getFieldClasses = (fieldName) => {
    const status = getFieldStatus(fieldName);
    const baseClasses = "w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg focus:ring-2 focus:border-transparent placeholder-gray-400 transition-all duration-200";
  ...
  return (
    <div className="min-h-screen bg-white pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-4 sm:pb-8 md:pb-12 lg:pb-16">
          ...
          <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-8 max-w-md w-full mx-4 transform transition-all duration-300 scale-100">
            <div className="text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-6">
                <p className="text-xs text-gray-600 mb-2 font-medium">What happens next?</p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-24">
          ...
          <ScrollAnimation direction="left" delay={0.1}>
            <div className="space-y-6 sm:space-y-8 w-full max-w-xl mx-auto xl:mx-0">
              ...
              <ScrollAnimation direction="up" delay={0.1}>
                <Link to="/about">
                  <button className="group border-2 border-[#222] text-[#222] px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base font-semibold flex items-center gap-2 transition-colors duration-200 hover:bg-[#222] hover:text-white focus:outline-none mb-6 sm:mb-8">
                    About Aram Medicals
              ...
              <div>
                ...
                <p className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed">
                  Get in touch with our medical professionals for consultations, appointments, and{' '}
                  <span className="font-semibold">healthcare services</span>. We're here to help you with all your{' '}
              ...
              <div className="border-t border-gray-200 pt-6 sm:pt-8">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 text-left">Aram Medical Foundation</h3>
                    <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                    91,91/1-91/4, New Scheme road, Pollachi - 642 001, Tamil Nadu, India
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-6 sm:pt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4 hover:bg-gray-100 transition-colors duration-200">
                    <h4 className="text-xs sm:text-sm font-medium text-gray-900 mb-1">Email</h4>
                    <p className="text-xs sm:text-sm text-gray-600 break-all">info@arammedicalfoundation.com</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4 hover:bg-gray-100 transition-colors duration-200">
                    <h4 className="text-xs sm:text-sm font-medium text-gray-900 mb-1">Mobile</h4>
                    <p className="text-xs sm:text-sm text-gray-600">+91 8667411477</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <ScrollAnimation direction="right" delay={0.2}>
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 lg:p-10 border border-gray-100 w-full max-w-xl mx-auto xl:mx-0">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">Get in Touch</h2>

              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div>
                  <label htmlFor="fullName" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1 sm:mb-2 text-left">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={getFieldClasses('fullName') + ' text-sm sm:text-base'}
                      required
                    />
                ...
                <div>
                  <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1 sm:mb-2 text-left">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={getFieldClasses('email') + ' text-sm sm:text-base'}
                      required
                    />
                    <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                      {getFieldIcon('email')}
                ...
                <div>
                  <label htmlFor="phone" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1 sm:mb-2 text-left">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={getFieldClasses('phone') + ' text-sm sm:text-base'}
                      required
                    />
                    <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                      {getFieldIcon('phone')}
                ...
                <div>
                  <label htmlFor="address" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1 sm:mb-2 text-left">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className={getFieldClasses('address') + ' resize-none text-sm sm:text-base'}
                      required
                    />
                ...
                <div>
                  <label htmlFor="department" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1 sm:mb-2 text-left">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={getFieldClasses('department') + ' bg-white text-sm sm:text-base'}
                      required
                    >
                ...
                <div>
                  <label htmlFor="message" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1 sm:mb-2 text-left">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className={getFieldClasses('message') + ' resize-none text-sm sm:text-base'}
                    />
                    <div className="absolute right-3 top-3">
                  ...
                  <div className="flex justify-between text-xs text-gray-500 mt-1">
                    ...
                    <span className={formData.message.length > 450 ? 'text-orange-500' : ''}>
