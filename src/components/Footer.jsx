    ...
    <div className="bg-[#212878] text-white shadow-xl p-8 w-full">
      <div className="text-center mb-6">
        ...
        <p className="text-lg opacity-90">
          Get expert Health care at Aram Medical Foundation
        </p>
      </div>

      <div className="flex flex-wrap flex-row justify-center items-center w-100">
        <div className="text-center w-1/2 md:w-1/3 gap-8 mb-4">
          <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3">
            <FaClock className="text-xl" />
          </div>
          <h4 className="font-semibold mb-2">Phone</h4>
          <p className="text-sm opacity-90">
            <a href="tel:+918667411477" className="hover:underline">
              +91 86674 11477
            </a>
          </p>
        </div>
        ...
        <div className="text-center w-1/2 md:w-1/3 gap-8 mb-4">
          ...
          <p className="text-sm opacity-90">
            <a
              href="mailto:info@arammedicalfoundation.com"
